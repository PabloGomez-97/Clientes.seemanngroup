...
//   - operaciones:    Acceso a cotizador, reportería/documentación global y trackeos globales
//
...
export const EJECUTIVO_ROUTES: string[] = [
  ...
  '/admin/simulador-cotizaciones',
  '/admin/clientes',
  '/admin/clientes/tracking',
  '/admin/clientes/reporteria',
  '/admin/clientes/documentacion',
...
export const OPERACIONES_ROUTES: string[] = [
  ...
  '/admin/cotizador',
  '/admin/simulador-cotizaciones',
  '/admin/operaciones/clientes/reporteria',
