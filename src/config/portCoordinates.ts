...
export const portCoordinates: Record<string, PortCoords> = {
  ...
  // --- Alias / typos LCL (nombres tal cual en tarifas) ---
  ahmaddabad: { lat: 22.9626, lng: 72.4934, name: "ICD Ahmedabad", unlocode: "INAMD" },
  basle: { lat: 47.5855, lng: 7.5932, name: "Port of Basel", unlocode: "CHBSL" },
  betim: { lat: -19.9681, lng: -44.1983, name: "Betim (Inland)", unlocode: "BRBTM" },
  birmimham: { lat: 52.4539, lng: -1.7478, name: "Birmingham (Inland Port)", unlocode: "GBBHX" },
  bucarest: { lat: 44.4268, lng: 26.1025, name: "Bucharest (Inland Port)", unlocode: "ROBUH" },
  calcuta: { lat: 22.5466, lng: 88.3111, name: "Port of Kolkata", unlocode: "INCCU" },
  calcutta: { lat: 22.5466, lng: 88.3111, name: "Port of Kolkata", unlocode: "INCCU" },
  canoas: { lat: -29.9178, lng: -51.1836, name: "Canoas (Inland)", unlocode: "BRCNR" },
  copenhagem: { lat: 55.7045, lng: 12.6022, name: "Port of Copenhagen", unlocode: "DKCPH" },
  copenhaguen: { lat: 55.7045, lng: 12.6022, name: "Port of Copenhagen", unlocode: "DKCPH" },
  danang: { lat: 16.1188, lng: 108.2144, name: "Port of Da Nang", unlocode: "VNDAD" },
  dubai: { lat: 24.9922, lng: 55.0566, name: "Port of Jebel Ali (Dubai)", unlocode: "AEAJA" },
  fermentle: { lat: -32.0466, lng: 115.7488, name: "Port of Fremantle", unlocode: "AUFRE" },
  fukuyama: { lat: 34.4494, lng: 133.2514, name: "Port of Fukuyama", unlocode: "JPFKY" },
  genova: { lat: 44.4042, lng: 8.9166, name: "Port of Genoa", unlocode: "ITGOA" },
  gotemburgo: { lat: 57.6966, lng: 11.8844, name: "Port of Gothenburg", unlocode: "SEGOT" },
  gothernburg: { lat: 57.6966, lng: 11.8844, name: "Port of Gothenburg", unlocode: "SEGOT" },
  haiphong: { lat: 20.8655, lng: 106.6911, name: "Port of Hai Phong", unlocode: "VNHPH" },
  hochiminh: { lat: 10.7622, lng: 106.7211, name: "Port of Ho Chi Minh", unlocode: "VNSGN" },
  huangpu: { lat: 23.0888, lng: 113.4566, name: "Port of Guangzhou (Huangpu)", unlocode: "CNWHI" },
  istambul: { lat: 41.0156, lng: 28.9794, name: "Port of Istanbul", unlocode: "TRIST" },
  jeddah: { lat: 21.4858, lng: 39.1925, name: "Port of Jeddah", unlocode: "SAJED" },
  kaoshiung: { lat: 22.5844, lng: 120.2922, name: "Port of Kaohsiung", unlocode: "TWKHH" },
  lisboa: { lat: 38.7111, lng: -9.1122, name: "Port of Lisbon", unlocode: "PTLIS" },
  madras: { lat: 13.1002, lng: 80.2975, name: "Port of Chennai (Madras)", unlocode: "INMAA" },
  moji: { lat: 33.9442, lng: 130.9639, name: "Port of Moji", unlocode: "JPMOJ" },
  naha: { lat: 26.2222, lng: 127.6811, name: "Port of Naha", unlocode: "JPNAH" },
  nanzhuang: { lat: 24.5850, lng: 120.9980, name: "Nanzhuang", unlocode: "TWNZH" },
  pennang: { lat: 5.3888, lng: 100.3722, name: "Port of Penang", unlocode: "MYPEN" },
  phnom_phenh: { lat: 11.5866, lng: 104.9222, name: "Port of Phnom Penh", unlocode: "KHPNH" },
  pireaus: { lat: 37.9511, lng: 23.6166, name: "Port of Piraeus", unlocode: "GRPIR" },
  port_kelang: { lat: 2.9988, lng: 101.3922, name: "Port Klang", unlocode: "MYPKG" },
  sao_jose_dos_pinhais: { lat: -25.5342, lng: -49.2058, name: "Sao Jose dos Pinhais (Inland)", unlocode: "BRSJP" },
  seatle: { lat: 47.5866, lng: -122.3422, name: "Port of Seattle", unlocode: "USSEA" },
  semerang: { lat: -6.9411, lng: 110.4222, name: "Port of Semarang", unlocode: "IDSRG" },
  sendai: { lat: 38.2682, lng: 141.0261, name: "Port of Sendai", unlocode: "JPSDJ" },
  shimuzu: { lat: 35.0169, lng: 138.4894, name: "Port of Shimizu", unlocode: "JPSMZ" },
  shimizu: { lat: 35.0169, lng: 138.4894, name: "Port of Shimizu", unlocode: "JPSMZ" },
  taipei: { lat: 25.1388, lng: 121.7422, name: "Port of Keelung (Taipei)", unlocode: "TWKEL" },
  tilbury: { lat: 51.4608, lng: 0.3456, name: "Port of Tilbury", unlocode: "GBTIL" },
  leghorn: { lat: 43.5622, lng: 10.3059, name: "Port of Leghorn", unlocode: "ITLGP" },
  guaira: {
    lat: 10.6028,
    lng: -66.9492,
    name: "Port of Guaira",
