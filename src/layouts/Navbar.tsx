// src/layouts/Navbar.tsx — Chrome del portal de clientes (Enterprise Dark)
    ...
    >
      ...
      <div className="cnav-actions">
        ...
        <button
          type="button"
          onClick={toggleChat}
          aria-label={t("home.navbar.openAssistant")}
          title={t("home.navbar.assistant")}
          className="cnav-assistant"
        >
          <svg
            width="14"
            height="14"
          ...
          <span>{t("home.navbar.assistant")}</span>
        </button>
        ...
        <button
          ...
          aria-label={
            darkMode
              ? t("home.navbar.darkModeOff")
              : t("home.navbar.darkModeOn")
          }
          title={
            darkMode ? t("home.navbar.lightMode") : t("home.navbar.darkMode")
          }
        >
          {darkMode ? (
            <svg
