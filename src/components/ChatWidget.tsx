          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: '12px', opacity: 0.85, fontWeight: '400' }}>
          ...
          >
            ...
            {messages.length === 0 && (
              ...
              >
                ...
                {['¿Qué es FCL?', '¿Qué es EXW?', '¿Qué es AWB?'].map((option, idx) => (
                  <button
                    key={idx}
              ...
              >
                ...
                <div
                  style={{
                    ...
                    padding: '12px 16px',
                    borderRadius: '12px',
                    backgroundColor: msg.role === 'user' ? '#425b76' : '#eaf0f6',
          ...
          >
            <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-end' }}>
              ...
              <button
                ...
                style={{
                  padding: '12px 14px',
                  backgroundColor: isLoading || !inputValue.trim() ? '#9ca3af' : '#425b76',
                  color: 'white',
                  border: 'none',
                  borderRadius: '10px',
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = isLoading || !inputValue.trim() ? '#9ca3af' : '#425b76';
                  e.currentTarget.style.transform = 'translateY(0)';
