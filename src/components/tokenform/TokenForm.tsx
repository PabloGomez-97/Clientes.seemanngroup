        ...
        <div className="card shadow">
          <div className="card-body p-5">
            <div className="text-center mb-4">
              ...
              <p className="text-muted mb-4">Pega tu token OAuth 2.0 desde Postman</p>
            </div>

            <div className="alert alert-info">
              <h6 className="alert-heading">Cómo obtener el token desde Postman:</h6>
            ...
            <div>
              <div className="mb-3">
                <label htmlFor="token" className="form-label fw-bold">Access Token</label>
                <textarea
                ...
                <small className="form-text text-muted">
                  El token expirará según la configuración de Linbis (usualmente 1 hora)
                </small>
              </div>
