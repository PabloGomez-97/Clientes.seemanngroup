  ...
  useEffect(() => {
    const cargarExcel = async () => {
      try {
        ...
        const response = await fetch('/src/assets/PLUSCARGO.xlsx');
        ...
        const regiones = [
          { nombre: 'AMERICA', inicio: 2, fin: 98, type: 'VOLUME_EUROPA' as const },
          { nombre: 'EUROPA', inicio: 101, fin: 124, type: 'W/M' as const }
        ];
    ...
    if (ruta.tariff_type === 'W/M') {
      return (
        <>
          ...
          <div>
            <strong>Ocean Freight Min:</strong> {ruta.of_min} {ruta.currency}
          </div>
        </>
      );
      ...
      return (
        <>
          <div className="mb-2">
            <strong>Tarifa (0.1 a 15 cbm):</strong> {ruta.of_wm} {ruta.currency}
          </div>
          <div>
  ...
  return (
    <div className="container mt-4 mb-5">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-muted">Transporte LCL - Seemann Group PLUSCARGO</p>
      </div>
