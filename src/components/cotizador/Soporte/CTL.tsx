  ...
  useEffect(() => {
    const cargarExcel = async () => {
      try {
        ...
        const response = await fetch('/src/assets/CTL.xlsx');
        ...
        const regiones = [
          { nombre: 'AMERICA', inicio: 10, fin: 17, type: 'W/M' as const },
          { nombre: 'EUROPA', inicio: 20, fin: 101, type: 'VOLUME_EUROPA' as const }
        ];
