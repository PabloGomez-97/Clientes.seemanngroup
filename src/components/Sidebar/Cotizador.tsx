        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Escoge el tipo de cotización que mejor se adapte a tus necesidades de envío
            </p>
          </div>
          ...
          <div style={{
            ...
            >
              ...
              <p style={{
                ...
                Cotización de carga aérea con tarifas por kilogramo en diferentes rangos de peso
              </p>
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 30px 60px -12px rgba(16, 185, 129, 0.3)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                e.currentTarget.style.borderColor = 'transparent';
            ...
            >
              ...
              <p style={{
                ...
                Full Container Load con tarifas por contenedor completo (20GP, 40HQ, 40NOR)
              </p>
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 30px 60px -12px rgba(168, 85, 247, 0.3)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0) scale(1)';
                e.currentTarget.style.borderColor = 'transparent';
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  Perfecto para envíos urgentes o productos de alto valor. Velocidad garantizada con tarifas competitivas basadas en peso.
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{
                  ...
                  Ideal para grandes volúmenes. Contenedor exclusivo para máxima seguridad y mejor costo por unidad transportada.
                </p>
              </div>
              ...
              <div>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <svg width="16" height="16" fill="#a855f7" viewBox="0 0 16 16">
                ...
                <p style={{
                  ...
                  Solución económica para volúmenes medianos. Comparte espacio en contenedor optimizando costos sin sacrificar calidad.
                </p>
              </div>
            </div>
          </div>
