...
function ShipsGoTracking() {
  ...
  const userShipments = useMemo(() => {
    ...
    return allShipments.filter((shipment) => {
      return (
        shipment.reference !== null && shipment.reference === user.username
      );
    });
          ...
          <div key={`delay-${shipment.id}`} className="delay-alert">
            ...
            <div className="delay-content">
              ...
              <p className="delay-message">
                Estamos obteniendo mayor información respecto al retraso de su
                cargamento. Lamentamos los inconvenientes.
              </p>
            </div>
          </div>
        ))}
                  ...
                  {shipment.route ? (
                    <div className="location-cell">
                      <div className="location-header">
                        ...
                        <img
                          src={getFlagUrl(
                            shipment.route.origin.location.country.code,
                          )}
                      ...
                      <div className="location-date">
                        {
                          formatDateCompact(
                            shipment.route.origin.date_of_dep,
                          ).split("\n")[0]
                        }
                        <br />
                        {
                    ...
                    <div className="transit-cell">
                      ...
                      <div className="progress-mini">
                        <div
                          ...
                          style={{
                            width: `${shipment.route.transit_percentage}%`,
                          }}
                        ></div>
                      </div>
                  ...
                  {shipment.route ? (
                    <div className="location-cell">
                      <div className="location-header">
                        ...
                        <img
                          src={getFlagUrl(
                            shipment.route.destination.location.country.code,
                          )}
                ...
                {selectedShipment.route && (
                  ...
                  >
                    ...
                    {selectedShipment.route.destination.date_of_rcf && (
                      <div className="timeline-compact-item">
                        <div
                          className={`timeline-compact-marker ${
                            selectedShipment.route.transit_percentage === 100
                              ? "completed"
                              : ""
                          }`}
                ...
                {selectedShipment.route && (
                  <div className="modal-route-section">
                    <div className="modal-route-grid">
                      ...
                      <div className="modal-route-point">
                        <div className="modal-route-label destination">
                          Destino
                        </div>
                        <div className="modal-route-location">
                        ...
                        <div className="modal-route-iata">
                          {selectedShipment.route.destination.location.iata} •{" "}
                          {
                            selectedShipment.route.destination.location.country
                              .name
                          }
                        </div>
                      </div>
                    ...
                    <div className="modal-route-details">
                      <div className="modal-route-detail-item">
                        <div className="modal-route-detail-label">
                          Tiempo de Tránsito
                        </div>
                        <div className="modal-route-detail-value">
                          {selectedShipment.route.transit_time}h
                        </div>
                      </div>
                      <div className="modal-route-detail-item">
                        <div className="modal-route-detail-label">Escalas</div>
                        <div className="modal-route-detail-value">
                          {selectedShipment.route.ts_count}
                        </div>
                      </div>
                      <div className="modal-route-detail-item">
