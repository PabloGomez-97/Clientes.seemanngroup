...
export const PDFTemplateFCL: React.FC<PDFTemplateFCLProps> = ({
  ...
  return (
    <div id="pdf-content" style={pageStyle}>
      ...
      {/* Commodities table - FCL specific */}
      <div
        style={{
            ...sectionStyle,
        ...
        <table style={tableStyle}>
          ...
          <tbody>
            <tr>
              <td style={{ ...tdStyle, ...center, fontWeight: 600 }}>{containerQuantity}</td>
              <td style={{ ...tdStyle, fontWeight: 600 }}>{containerType}</td>
        ...
        >
          <div>
            <span style={gridLabelStyle}>Total Containers:</span> {containerQuantity}
          </div>
          <div>
            <span style={gridLabelStyle}>Container Type:</span> {containerType}
          </div>
        </div>
      </div>
