...
import { type OutletContext, type AirShipment, ShipmentTimeline, CollapsibleSection, InfoField, CommoditiesSection, SubShipmentsList} from '../shipments/Handlers/Handlersairshipments';
...
function AirShipmentsView() {
  ...
  const tooltipMessages = {
    numero: "Número a utilizar para rastrear el envío con la aerolínea o transportista.",
