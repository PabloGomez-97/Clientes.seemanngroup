  ...
  return (
    <div className="container-fluid">
      <div className="row mb-4">
        <div className="col">
          <h2 className="mb-0">Modulo de Prueba para Shipgo</h2>
      ...
      <div className="card shadow-sm">
        <div className="card-body text-center py-5">
          ...
          <h4 className="text-muted">Módulo de shipgo</h4>
          <p className="text-muted">Esta sección está pendiente de implementación para los rastreos aéreos de shipgo</p>
