...
function ReporteriaPersonalizable() {
  ...
  const [filterMode, setFilterMode] = useState<"individual" | "comparison">(
    "individual",
  );
  ...
  const [compareMonth1, setCompareMonth1] = useState<number>(
    new Date().getMonth() + 1,
  );
  ...
  const [shipmentModalData, setShipmentModalData] =
    useState<ShipmentModalData | null>(null);
    ...
    try {
      ...
      if (resetData) {
        ...
        if (batchInvoices.length > 0) {
          const firstConsignee =
            batchInvoices[0].billTo?.name ||
            batchInvoices[0].shipment?.consignee?.name;
          if (firstConsignee) {
        ...
        console.log(
          `Cargadas ${batchInvoices.length} facturas más. Total: ${updatedInvoices.length}`,
        );
      }
    ...
    if (accessToken) {
      ...
      if (cachedInvoices && cachedTimestamp) {
        ...
        if (cacheAge < CACHE_DURATION) {
          ...
          if (parsed.length > 0) {
            const firstConsignee =
              parsed[0].billTo?.name || parsed[0].shipment?.consignee?.name;
            if (firstConsignee) {
              setSelectedConsignee(firstConsignee);
            }
          }
  ...
  const monthlyExpensesData = useMemo(() => {
    ...
    filteredInvoices.forEach((inv) => {
      ...
      dataByYearCurrency[key][month] =
        (dataByYearCurrency[key][month] || 0) + total;
    });
  ...
  const comparativeData = useMemo(() => {
    ...
    filteredInvoices.forEach((inv) => {
      ...
      if (year === compareYear1 && month === compareMonth1) {
        ...
        month1Data.count += 1;
        month1Data.currency[currency] =
          (month1Data.currency[currency] || 0) + total;
      ...
      if (
        ...
        month2Data.count += 1;
        month2Data.currency[currency] =
          (month2Data.currency[currency] || 0) + total;
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            <button
              ...
              style={{
                ...
                backgroundColor:
                  filterMode === "individual" ? COLORS.primary : "white",
            ...
            <button
              ...
              style={{
                ...
                backgroundColor:
                  filterMode === "comparison" ? COLORS.primary : "white",
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      onClick={() =>
                        data.overdue > 0 && openOverdueModal(currency)
                      }
                    >
                      <span
                        style={{
                    ...
                    {displayedInvoices
                      .filter((inv) => {
                        if (filterMode === "individual" && selectedConsignee) {
                          ...
                          (consignee1 || consignee2)
                        ) {
                          const consigneeName =
                            inv.billTo?.name || inv.shipment?.consignee?.name;
                          return (
                            consigneeName === consignee1 ||
                            consigneeName === consignee2
                          );
                        }
                        return true;
                      })
                      .map((inv, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td
                              style={{ padding: "12px 16px", color: "#4b5563" }}
                            >
                              {formatDate(inv.date)}
                            </td>
                            <td
                            ...
                            >
                              {formatCurrency(
                                inv.totalAmount?.value || 0,
                                inv.currency?.abbr || "USD",
                              )}
                            </td>
                            <td
                              style={{
                  ...
                  <div style={{ marginBottom: "24px" }}>
                    ...
                    <div style={{ overflowX: "auto" }}>
                      ...
                      >
                        ...
                        <tbody>
                          {processCharges(selectedInvoice.charges).map(
                            (charge, idx) => (
                              <tr
                                key={idx}
                          ...
                          {selectedInvoice.totalAmount?.value && (
                            ...
                            >
                              ...
                              >
                                {(() => {
                                  const totalCharges = processCharges(
                                    selectedInvoice.charges,
                                  ).reduce(
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {formatCurrency(
                        selectedInvoice.amount?.value || 0,
                        "CLP",
                      )}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    >
                      {formatCurrency(
                        selectedInvoice.taxAmount?.value || 0,
                        "CLP",
                      )}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    >
                      {formatCurrency(
                        selectedInvoice.totalAmount?.value || 0,
                        "CLP",
                      )}
                    </span>
                  </div>
                ...
                >
                  <span
                    style={{
                      ...
                      color: (() => {
                        const balanceDue =
                          selectedInvoice.balanceDue?.value || 0;
                        return balanceDue === 0 ? "#10b981" : "#f59e0b";
                      })(),
                    }}
                  >
                    ...
                    {(() => {
                      ...
                      if (
                        ...
                        if (totalCharges > 0) {
                          ...
                          const exchangeRate =
                            (selectedInvoice.totalAmount.value / totalCharges) *
                            2;
          ...
          >
            ...
            <div style={{ padding: "24px" }}>
              ...
              >
                ...
                >
                  Para ver los detalles completos de este envío, dirígete a la
                  sección de{" "}
                  <strong>
                    {shipmentModalData.type === "air"
                      ? "Air Shipments"
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: "0.9rem", opacity: 0.9 }}>
                    ...
                    {overdueInvoices.length === 1 ? "factura" : "facturas"}{" "}
                    encontradas
                  </div>
                </div>
                <button
            ...
            <div style={{ padding: "20px", overflowY: "auto", flex: 1 }}>
              {overdueInvoices.length === 0 ? (
                <div style={{ textAlign: "center", color: "#6b7280" }}>
                  No hay facturas vencidas en {overdueCurrency}.
                </div>
              ) : (
                <div style={{ overflowX: "auto" }}>
                  <table
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "24px", overflowY: "auto", flex: 1 }}>
                ...
                <div style={{ overflowX: "auto" }}>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      {/* Total por moneda */}
                      {Object.keys({
                        ...comparativeData.month1.currency,
                        ...comparativeData.month2.currency,
                      }).map((currency) => (
                        <tr
                          key={currency}
                          style={{ borderBottom: "1px solid #f3f4f6" }}
                        >
                          ...
                          >
                            {formatCurrency(
                              comparativeData.month1.currency[currency] || 0,
                              currency,
                            )}
                          </td>
                          {compareMonth2 && compareYear2 && (
                            <>
                              ...
                              >
                                {formatCurrency(
                                  comparativeData.month2.currency[currency] ||
                                    0,
                                  currency,
                                )}
                              </td>
              ...
              {(Object.keys(comparativeData.month1.services).length > 0 ||
                Object.keys(comparativeData.month2.services).length > 0) && (
                <div>
                  <h6
                    style={{
                      fontSize: "1rem",
                  ...
                  {(() => {
                    ...
                    const chartData = Array.from(allServices)
                      .map((service) => ({
                        name: service,
                      ...
                      .sort(
                        (a, b) =>
                          b.periodo1 + b.periodo2 - (a.periodo1 + a.periodo2),
                      )
                      .slice(0, 10);
