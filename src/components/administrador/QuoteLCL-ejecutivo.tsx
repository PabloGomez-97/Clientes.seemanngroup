...
import { PDFTemplateLCL } from "../quotes/Pdftemplate/Pdftemplatelcl";
import {
  generatePDF,
  generatePDFBase64,
...
import { PieceAccordionLCL } from "../quotes/Handlers/LCL/PieceAccordionLCL.tsx";
...
import {
  ...
  getPODDisplayName,
  parseLCL,
} from "../quotes/Handlers/LCL/HandlerQuoteLCL.tsx";
      ...
      try {
        const emailResponse = await fetch("/api/send-operation-email", {
          ...
          body: JSON.stringify({
            ...
            clienteNombre: clienteSeleccionado?.username,
