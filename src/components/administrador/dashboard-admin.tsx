    ...
    changes: [
      {
        type: "feature",
        description:
          "Imágenes de carriers en todas las cotizaciones (Aéreas, LCL y FCL)",
      },
      {
        type: "feature",
        description:
          "Sistema de notificación cuando cliente selecciona cotización con costo $0 (caso a caso)",
      },
      {
        type: "feature",
        description:
          'Nuevos badges "Mejor opción" y "Menor tiempo" para facilitar decisión del cliente',
      },
      {
        type: "feature",
        description:
          "Componente Changelog para visualizar actualizaciones del portal de clientes y ejecutivos",
      },
      {
        type: "feature",
        description:
          "Alerta en LCL cuando cliente escoge ruta con valor $0 para contactar con ejecutivo",
      },
      {
        type: "fix",
      ...
      },
      {
        type: "fix",
        description:
          "Normalización de nombres de puertos LCL: San Antonio - Valparaíso ahora se muestra como San Antonio / Valparaíso",
      },
    ],
  },
  {
    ...
    changes: [
      {
        type: "feature",
        description:
          "Nuevo sistema de búsqueda avanzada en el módulo de embarques",
      },
      {
        type: "feature",
        description:
          "Dashboard de analytics con gráficos interactivos en tiempo real",
      },
      {
        type: "improvement",
        description:
          "Optimización del rendimiento en la carga de datos de cotizaciones",
      },
      {
        type: "improvement",
    ...
    changes: [
      {
        type: "feature",
        description:
          "Integración con API de Linbis para tracking en tiempo real",
      },
      {
        type: "improvement",
  ...
  },
  {
    ...
    changes: [
      ...
      },
      {
        type: "improvement",
        description:
          "Mejoras significativas en la velocidad de carga de páginas",
      },
    ],
  },
];
            ...
            >
              ...
              <div
                style={{
                  ...
                  boxShadow:
                    index === 0 ? "0 0 20px rgba(99, 102, 241, 0.5)" : "none",
                  zIndex: 1,
                }}
              />
              ...
              >
                ...
                <div
                  style={{
                    background:
                      index === 0 ? GRADIENTS.purple : COLORS.background,
                    padding: "20px 24px",
                    display: "flex",
