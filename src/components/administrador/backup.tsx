            ...
            <>
                  ...
                  {rutasFiltradas.length > 0 && (
                    <div className="alert alert-light border-0 mt-3">
                      <small className="text-muted">
                        ...
                        referenciales y pueden variar según volumen y servicios
                        adicionales
                      </small>
                    </div>
                  )}
              ...
              {rutaSeleccionada && (
                <div className="alert alert-success mt-4 mb-0">
                  ...
                  <p className="mb-2">
                    <strong>Ruta:</strong> {rutaSeleccionada.pol} →{" "}
                  ...
                  <p className="mb-0">
                    <strong>Tarifa:</strong> {rutaSeleccionada.currency}{" "}
                    {rutaSeleccionada.ofWM}/W/M
                  </p>
                </div>
              )}
            </>
              ...
              <div className="row g-2" style={{ fontSize: "0.9rem" }}>
                ...
                {tarifaOceanFreight && (
                  <>
                    ...
                    <div className="col-md-6">
                      <strong>Tarifa base:</strong> {rutaSeleccionada.currency}{" "}
                      {rutaSeleccionada.ofWM}/W/M
                    </div>
                    <div className="col-md-6">
