/**
 * Template HTML para notificación de cotización u operación marítima LCL.
...
function isOperacion(data: LclQuoteEmailData): boolean {
  return data.tipoAccion === 'operacion';
}

function tipoTitulo(data: LclQuoteEmailData): string {
  return isOperacion(data) ? 'Nueva operación marítima LCL' : 'Nueva cotización marítima LCL';
}

function badgeLine1(data: LclQuoteEmailData): string {
...
function formatClienteLine(data: LclQuoteEmailData): string {
...
function formatTotal(data: LclQuoteEmailData): string {
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="padding-left:10px;">
                          ...
                          <p style="margin:3px 0 0;font-family:${FONT};font-size:12px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:${C.primary};line-height:1.2;">LCL</p>
                        </td>
                      </tr>
                    </table>
                  </td>
