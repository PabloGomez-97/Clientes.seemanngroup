  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Tarifas proveedores</Text>
        <View style={styles.backBtn} />
      </View>
      <Text style={styles.subtitle}>Consulta de todas las compañías</Text>
      ...
      <View style={styles.searchWrap}>
        ...
        <TextInput
          style={styles.search}
          placeholder="Buscar ruta, compañía, carrier…"
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>No hay tarifas en este modo.</Text>
          }
          ListFooterComponent={
            filtered.length > 0 ? (
