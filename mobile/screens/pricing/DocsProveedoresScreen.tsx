...
export default function DocsProveedoresScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Docs proveedores</Text>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={styles.empty}>No hay documentos de proveedores.</Text>
          }
          ListFooterComponent={
            filtered.length > 0 ? (
