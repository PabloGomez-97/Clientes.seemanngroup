...
async function main() {
  ...
  const sessionsCol = db.collection<SessionIdDoc>('whatsapp_admin_sessions');
  ...
  const sessionsRes = await sessionsCol.deleteMany({});
    ...
    JSON.stringify(
      {
        ...
        deleted: {
          ...
          adminSessions: sessionsRes.deletedCount,
        },
      },
      null,
      2,
